...
public class ContinuationTokenUtils {
    public static String createContinuationToken(Window<?> window, int index) {
        if (!window.hasNext()) {
            return null;
        }

        KeysetScrollPosition nextScrollPosition = (KeysetScrollPosition) window.positionAt(index);
